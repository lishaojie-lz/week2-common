 ...
 * @Description: 字符串类型
 * @author: 敷小衍
 * @date: 2020年4月27日 上午9:05:06
 */
public class StringUtils {

	//返回一个中文字符串字符集必须是GB2312(相当于中文简体)范围内，列如“中”
	...
	public static String getZHString(int n){
		...
		for (int i = 0; i <n; i++) {
			sBuffer.append(randomChineseString());
		}
	...
	public static String getZHName(){
		...
		String[] str = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤",
				...
				//姓
				String s1=str[RandNumUtils.random(0, str.length-1)];
				//名
				String s2=getZHString(RandNumUtils.random(1, 2));
		return s1+s2;
	//TODO 实现代码
	}
}
